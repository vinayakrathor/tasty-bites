...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-5 grid md:grid-cols-2 gap-10 md:gap-20 items-center">
        <div className="relative overflow-hidden">
          ...
          <img src="https://images.unsplash.com/photo-1556910103-1c02745aae4d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80" alt="Chef Cooking" className="absolute -bottom-6 sm:-bottom-8 right-0 w-2/5 sm:w-1/2 rounded-xl shadow-xl border-4 border-white" />
          <div className="absolute top-6 sm:top-8 right-8 sm:right-12 bg-orange-500 text-white p-4 sm:p-6 rounded-xl text-center">
        ...
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-5">We Serve Happiness on a Plate</h2>
